...
export class ProductService {
  ...
  getProducts(): Observable<IProduct[]> {
    // To perform time check and expire data,
    // define another property to capture time data is retrieved from backend and set in tap operator.
    // Perform check in if to see if data is before expiration time.
    if (this.products) {
